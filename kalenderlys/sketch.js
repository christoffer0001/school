...
function draw() {
  ...
  if (currentDate >= startDate && currentDate <= endDate) {
    ...
    //define rect values
    const candleBaseHeight = canvasHeight - canvasHeight / 4;
    let rectCurrentHeight = (candleBaseHeight / ms_dif) * ms_elapsed + 5;
    ...
    */
    ...
    let circleXRight =
      candleXPosition + candleWidth + circleDiameter / 2 + circleBuffer;
    ...
    image(star, 0, canvasHeight / 16, 200, 200);
    image(star, (canvasWidth / 4) * 3, canvasHeight / 16, 200, 200);
